      ...
      <div className="login-container animate-fade-in-up">
        ...
        <div className="login-card glass-card">
          <div className="login-header">
            ...
            <h1>Services</h1>
            <p>Connect AI-powered agents to your everyday tools</p>
          </div>
        ...
        {/* Feature cards below */}
        <div className="login-features animate-fade-in-up delay-200">
          <div className="feature-card glass-card">
            <span className="feature-icon">📅</span>
            <span className="feature-text">Calendar Management</span>
          </div>
          <div className="feature-card glass-card">
            <span className="feature-icon">💬</span>
